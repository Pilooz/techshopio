...
HELP =  {
  ...
  'help-new-quantity' => {en: 'Quantity of this item. 1 is the default.', fr: 'Quantité. Par défaut 1.'},
  'help-new-consumable' =>  {en: 'The item is a consumable. However you can fix a price.', fr: 'Spécifie si l\'item est un consommable ou non. Si c\'est le cas, il peut avoir un prix.'},
  ...
  'help-modify' => {en: 'Click this button to modify only this item in database.',
                      fr: "Modifier uniquement cet item."},
  'help-modify-all' => {en: 'Click this button to modify all the items having the <u>same name and description</u> as this one.',
                      fr: "Modifier tous les items ayant le <u>même nom et description</u> que celui-ci."},
  'help-upload-csv' => {en: '',
